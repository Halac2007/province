          ...
          <div style="display:flex; gap:18px; justify-content:center; align-items:flex-start; margin-bottom:12px;">
            ${
              ...
              <div style="flex:1; text-align:center;">
                <img src="${
                  item.image_bi_thu || "Assets/png/default-user.png"
                }" alt="Đồng chí" style="width:100px;height:100px;object-fit:cover;border-radius:50%;border:2px solid #1a5c2b;margin-bottom:8px;">
              ...
              <div style="flex:1; text-align:center;">
                <img src="${
                  item.image_chu_tich || "Assets/png/default-user.png"
                }" alt="Đồng chí" style="width:100px;height:100px;object-fit:cover;border-radius:50%;border:2px solid #1a5c2b;margin-bottom:8px;">
                <div style="margin-bottom:2px;">Đồng chí</div>
              ...
              <div style="flex:1; text-align:center; margin: 0 auto;">
                <img src="${
                  item.image_bi_thu || "Assets/png/default-user.png"
                }" alt="Đồng chí" style="width:120px;height:120px;object-fit:cover;border-radius:50%;border:2px solid #1a5c2b;margin-bottom:8px;">
